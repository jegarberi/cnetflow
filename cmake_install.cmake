...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  if(EXISTS "$ENV{DESTDIR}/usr/local/cnetflow/libarena.so" AND
    ...
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/cnetflow/libarena.so"
         OLD_RPATH "/home/jon/.conan2/p/b/libuv1e16d49b0cae9/p/lib:"
         NEW_RPATH "")
    if(CMAKE_INSTALL_DO_STRIP)
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}/usr/local/cnetflow/libdb_psql.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/cnetflow/libdb_psql.so")
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/cnetflow/libdb_psql.so"
         RPATH "")
  endif()
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/local/cnetflow/libdb_psql.so")
  if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(WARNING "ABSOLUTE path INSTALL DESTINATION : ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  endif()
  if(CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
  ...
  file(INSTALL DESTINATION "/usr/local/cnetflow" TYPE SHARED_LIBRARY FILES "/home/jon/CLionProjects/cnetflow/libdb_psql.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/cnetflow/libdb_psql.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/cnetflow/libdb_psql.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/cnetflow/libdb_psql.so"
         ...
         NEW_RPATH "")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/cnetflow/libdb_psql.so")
    endif()
  endif()
endif()
