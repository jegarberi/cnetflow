...
(
    ...
    constraint flows_agg_5min_unique
      ...
      timescaledb.hypertable,
      timescaledb.partition_column = 'exporter',
      timescaledb.segmentby = 'bucket_5min'
      );
...
(
    ...
    PRIMARY KEY (id, inserted_at)
      ...
      timescaledb.hypertable,
      timescaledb.partition_column = 'exporter',
      timescaledb.segmentby = 'inserted_at'
      );
...
(
    ...
    PRIMARY KEY (bucket_30min, exporter, srcaddr, dstaddr, srcport, dstport, protocol, src_as, dst_as, input, output)
      ...
      timescaledb.hypertable,
      timescaledb.partition_column = 'exporter',
      timescaledb.segmentby = 'bucket_30min'
      );
